...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'store-manager', 'marketing-specialist', 'customer-service-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Campaign', path: '/campaigns', entity: 'campaign', service: AccessServiceEnum.PROJECT, icon: FiPercent },
